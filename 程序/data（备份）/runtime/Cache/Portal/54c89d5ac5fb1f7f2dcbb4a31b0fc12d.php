  ...
  <div class="content"> 
    ...
    <div class="about">
      ...
      <img src="/public/picture/into09.png">
        ...
        <a href="<?php echo leuu('portal/list/index',array('id'=>$term['term_id']));?>">> <?php echo ($term["name"]); ?></a>
        <span>> <?php echo (mb_substr($post_title,0,18,'utf-8')); ?></span>
        </p>
      </div>
      <div class="clearfix"></div>
      <div class="case">
      <div class="news_view">
        <h1 style=""><?php echo (mb_substr($post_title,0,30,'utf-8')); ?></h1>
        <h2>时间：<span><?php echo date('Y-m-d',strtotime($post_date));?></span>来源：<a href="#"><?php echo ($post_source); ?></a>&nbsp;&nbsp;阅读：<span><?php echo ($post_hits); ?>次</span></h2>
      </div>
        ...
        <?php if(!empty($prev)): ?><a href="<?php echo leuu('portal/article/index',array('id'=>$prev['object_id'],'cid'=>$prev['term_id']));?>" title="<?php echo ($prev['post_title']); ?>">上一篇</a><?php endif; ?>
        <?php if(!empty($next)): ?><a href="<?php echo leuu('portal/article/index',array('id'=>$next['object_id'],'cid'=>$next['term_id']));?>" title="<?php echo ($next['post_title']); ?>">下一篇</a><?php endif; ?>
          </div>
        </div>
      </div>
