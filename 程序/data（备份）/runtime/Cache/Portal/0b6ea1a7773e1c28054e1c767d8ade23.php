...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('AdminProduct/index');?>"><?php echo L('PORTAL_ADMINPRODUCT_INDEX');?></a></li>
			<li><a href="<?php echo U('AdminProduct/add',array('term'=>empty($term['term_id'])?'':$term['term_id']));?>" target="_self"><?php echo L('PORTAL_ADMINPRODUCT_ADD');?></a></li>
			<li class="active"><a href="#"><?php echo L('PORTAL_ADMINPRODUCT_EDIT');?></a></li>
		</ul>
				...
				<div class="span9">
					<table class="table table-bordered">
                        ...
                        <tr>
							<th width="80">英文标题</th>
							<td>
								<input type="text" style="width: 400px;" name="post[post_title_en]" value="<?php echo ($post["post_title_en"]); ?>" placeholder="请输入英文标题" />
							</td>
						</tr>
						<tr>
							<th>关键词</th>
						...
						<tr>
							<th>英文关键词</th>
							<td>
								<input type="text" name="post[post_keywords_en]" style="width: 400px" value="<?php echo ($post['post_keywords_en']); ?>" placeholder="请输入关键字">
								多关键词之间用空格或者英文逗号隔开
							</td>
						</tr>
						<tr>
                        ...
                        <tr>
							<th>英文摘要</th>
							<td><textarea name="post[post_excerpt_en]" style="width: 98%; height: 50px;"><?php echo ($post["post_excerpt_en"]); ?></textarea>
							</td>
						</tr>
						<tr>
							<th>内容</th>
							<td>
								<script type="text/plain" id="content" name="post[post_content]"><?php echo htmlspecialchars_decode($post['post_content']);?></script>
							</td>
						</tr>
                        <tr>
							<th>英文内容</th>
							<td>
								<script type="text/plain" id="content_en" name="post[post_content_en]"><?php echo htmlspecialchars_decode($post['post_content_en']);?></script>
							</td>
						</tr>
						<tr>
							<th>工程图集</th>
