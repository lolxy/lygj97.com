...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="javascript:;">工艺管理</a></li>
			<li><a href="<?php echo U('AdminGongyi/add',array('term'=>empty($term['term_id'])?'':$term['term_id']));?>" target="_self"><?php echo L('PORTAL_ADMINPRODUCT_ADD');?></a></li>
		</ul>
		<form class="well form-search" method="post" action="<?php echo U('AdminGongyi/index');?>">
			分类： 
			...
			<a class="btn btn-danger" href="<?php echo U('AdminGongyi/index');?>">清空</a>
		</form>
		<form class="js-ajax-form" action="" method="post">
			<div class="table-actions">
				<?php if(!empty($term)): ?><button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('AdminGongyi/listorders');?>"><?php echo L('SORT');?></button><?php endif; ?>
				<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('AdminGongyi/check',array('check'=>1));?>" data-subcheck="true">审核</button>
				<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('AdminGongyi/check',array('uncheck'=>1));?>" data-subcheck="true">取消审核</button>
				<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('AdminGongyi/top',array('top'=>1));?>" data-subcheck="true">置顶</button>
				<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('AdminGongyi/top',array('untop'=>1));?>" data-subcheck="true">取消置顶</button>
				<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('AdminGongyi/recommend',array('recommend'=>1));?>" data-subcheck="true">推荐</button>
				<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('AdminGongyi/recommend',array('unrecommend'=>1));?>" data-subcheck="true">取消推荐</button>
				...
				<button class="btn btn-danger btn-small js-ajax-submit" type="submit" data-action="<?php echo U('AdminGongyi/delete');?>" data-subcheck="true" data-msg="您确定删除吗？"><?php echo L('DELETE');?></button>
			</div>
			<table class="table table-hover table-bordered table-list">
				<thead>
					<tr>
						...
						<th width="160"><?php echo L('KEYWORDS');?>/<?php echo L('ABSTRACT');?>/<?php echo L('THUMBNAIL');?></th>
				...
				<?php if(is_array($posts)): foreach($posts as $key=>$vo): ?><tr>
					...
					<td>
						<a href="<?php echo U('AdminGongyi/edit',array('id'=>$vo['id']));?>"><?php echo L('EDIT');?></a> | 
						<a href="<?php echo U('AdminGongyi/delete',array('id'=>$vo['id']));?>" class="js-ajax-delete"><?php echo L('DELETE');?></a>
					</td>
				...
				<tfoot>
					<tr>
						...
						<th width="50"><?php echo L('AUTHOR');?></th>
						<th width="50"><?php echo L('HITS');?></th>
						<th ><?php echo L('KEYWORDS');?>/<?php echo L('ABSTRACT');?>/<?php echo L('THUMBNAIL');?></th>
						<th width="100"><?php echo L('PUBLISH_DATE');?></th>
						<th width="50"><?php echo L('STATUS');?></th>
						<th width="70"><?php echo L('ACTIONS');?></th>
					</tr>
			...
			<div class="table-actions">
				...
				<?php if(!empty($term)): ?><button class="btn btn-primary btn-small js-articles-move" type="button">批量移动</button><?php endif; ?>
				<button class="btn btn-primary btn-small js-articles-copy" type="button">批量复制</button>
				<button class="btn btn-danger btn-small js-ajax-submit" type="submit" data-action="<?php echo U('AdminGongyi/delete');?>" data-subcheck="true" data-msg="你确定删除吗？"><?php echo L('DELETE');?></button>
			</div>
	...
	<script>
		function refersh_window() {
			...
			if (refersh_time == 1) {
				window.location = "<?php echo U('AdminGongyi/index',$formget);?>";
			}
		}
		...
		$(function() {
			...
			Wind.use('ajaxForm', 'artDialog', 'iframeTools', function() {
				...
				$('.js-articles-copy').click(function(e) {
					...
					ids= ids.join(',');
					art.dialog.open("/index.php?g=portal&m=AdminGongyi&a=copy&ids="+ ids, {
						title : "批量复制",
						width : "300px"
					});
				});
				...
				$('.js-articles-move').click(function(e) {
					...
					ids= ids.join(',');
					art.dialog.open("/index.php?g=portal&m=AdminGongyi&a=move&old_term_id=<?php echo ((isset($term["term_id"]) && ($term["term_id"] !== ""))?($term["term_id"]):0); ?>&ids="+ ids, {
						title : "批量移动",
						width : "300px"
					});
				});
