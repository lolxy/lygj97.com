...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('AdminGongyi/index');?>"><?php echo L('PORTAL_ADMINPRODUCT_INDEX');?></a></li>
			<li class="active"><a href="<?php echo U('AdminGongyi/add',array('term'=>empty($term['term_id'])?'':$term['term_id']));?>" target="_self"><?php echo L('PORTAL_ADMINPRODUCT_ADD');?></a></li>
		</ul>
		<form action="<?php echo U('AdminGongyi/add_post');?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
				...
				<div class="span9">
					<table class="table table-bordered">
						...
						<tr>
							<th width="80">标题</th>
							<td>
								<input type="text" style="width: 400px;" name="post[post_title]" id="title" value="" placeholder="请输入标题" required/>
                        ...
                        <tr>
							<th width="80">英文标题</th>
							<td>
								<input type="text" style="width: 400px;" name="post[post_title_en]" id="title_en" value="" placeholder="请输入英文标题"/>
							</td>
						</tr>
						<tr>
							<th>关键词</th>
                        ...
                        <tr>
							<th>英文关键词</th>
							<td><input type="text" name="post[post_keywords_en]" id="keywords" value="" style="width: 400px" placeholder="请输入关键字"> 多关键词之间用空格或者英文逗号隔开</td>
						</tr>
						<tr>
							<th>摘要</th>
							<td>
						...
						<tr>
							<th>英文摘要</th>
							<td>
								<textarea name="post[post_excerpt_en]" id="description_en" style="width: 98%; height: 50px;" placeholder="请填写英文摘要"></textarea>
							</td>
						</tr>
						<tr>
							<th>内容</th>
                        ...
                        <tr>
							<th>英文内容</th>
							<td>
								<script type="text/plain" id="content_en" name="post[post_content_en]"></script>
							</td>
						</tr>
						<tr>
							<th>工艺图集</th>
			...
			<div class="form-actions">
				...
				<a class="btn" href="<?php echo U('AdminGongyi/index');?>">返回</a>
			</div>
		</form>
	</div>
									...
									Wind.use("artDialog", function() {
										art.dialog({
											...
											button : [ {
												...
												name : '返回列表页',
												callback : function() {
													location = "<?php echo U('AdminGongyi/index');?>";
													return true;
												}
											} ]
										});
