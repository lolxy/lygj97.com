...
.table_list tr.expanded td .expander{
	background: url(/admin/themes/simplebootx/assets/images/tv-collapsable.gif) center center no-repeat;
}
.table_list tr.collapsed td .expander{
	background: url(/admin/themes/simplebootx/assets/images/tv-expandable.gif) center center no-repeat;
}
</style>
...
$(function(){
    $(".show_sub").click(function(){
        $(this).attr("src",function(){
            if(this.src == '/admin/themes/simplebootx/assets/images/tv-expandable.gif'){
                return '/admin/themes/simplebootx/assets/images/tv-collapsable.gif';
            } else {
                return '/admin/themes/simplebootx/assets/images/tv-expandable.gif';
            }
        });
